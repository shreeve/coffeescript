...
(function() {
  ...
  // ==============================================================================
  var creation_examples, dir, directives, ex, example, i, j, k, len, len1, len2, nesting_examples;
  ...
  then: {$ast: 'Assign', left: $ref: 2, right: $ref: 3}  # ← Creates AST node!
    ...
    },
    {
      ...
      code: `$var: 'temp', value: {$ast: 'Block', statements: []}  # ← Creates AST node!`,
  ...
  for (j = 0, len1 = nesting_examples.length; j < len1; j++) {
    example = nesting_examples[j];
  ...
  for (k = 0, len2 = creation_examples.length; k < len2; k++) {
    ex = creation_examples[k];
