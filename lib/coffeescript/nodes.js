...
// multiline need to be indented.
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      add(props) {
        ...
        filteredProps = Array.isArray(props) ? props.filter(function(p) {
          return p != null;
        }) : props != null ? [props] : [];
        this.properties = this.properties.concat(filteredProps);
        this.forceUpdateLocation = true;
        return this;
      }
  ...
  exports.Arr = Arr = (function() {
    class Arr extends Base {
      ...
      compileNode(o) {
        var answer, compiledObjs, fragment, fragmentIndex, fragmentIsElision, fragments, includesLineCommentsOnNonFirstElement, index, j, k, l, len1, len2, len3, len4, len5, obj, objIndex, olen, passedElision, q, r, ref1, ref2, unwrappedObj;
        if (!this.objects.length) {
