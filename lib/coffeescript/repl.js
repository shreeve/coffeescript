...
(function() {
  ...
  replDefaults = {
    ...
    eval: function(input, context, filename, cb) {
      var Assign, Block, Call, Code, Literal, Root, Value, ast, compileCS3, err, isAsync, js, ref, ref1, referencedVars, result, token, tokens, wrappedInput;
      // XXX: multiline hack.
