...
(function() {
  ...
  // ==============================================================================
  var all_directives, cat, dir, directives, i, item, j, k, len, len1, len2, ref;
  ...
  directives = [
    {
      ...
      items: [
        ...
        {
          name: "$obj",
          desc: "Plain object (no type)",
          example: "$obj: yes, source: $ref: 2"
        },
        {
          name: "$seq",
          desc: "Sequence of operations",
          example: "$seq: [{$var: 'x'}, {$use: 'x'}]"
        },
        {
          name: "$ops",
          desc: "Operations/methods",
          example: "$ops: 'push', target: $ref: 1"
        },
        {
          name: "$ary",
          desc: "Array literal/concat",
          example: "$ary: [$ref: 1, $ref: 2]"
        },
        {
          name: "$ite",
          desc: "If-Then-Else",
          example: "$ite: {test: $ref: 1, then: $ref: 2}"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        {
          name: "$var",
          desc: "Create temp variable",
          example: "$var: 'temp', value: $ref: 1"
        },
        {
          name: "$use",
          desc: "Use temp variable",
          example: "$use: 'temp'"
        }
      ]
    }
  ...
  for (k = 0, len2 = all_directives.length; k < len2; k++) {
    dir = all_directives[k];
    console.log(`  ${dir} ✓`);
  }
  ...
  console.log(`# A complex grammar rule using all directives:
