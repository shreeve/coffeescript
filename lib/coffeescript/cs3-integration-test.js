...
(function() {
  ...
  // ==============================================================================
  var CoffeeScript, error, expectedStructure, fs, originalJS, path, testCode, testFile;
  ...
  try {
    originalJS = CoffeeScript.compile(testCode, {
      bare: true
    });
  ...
  expectedStructure = `var square = function(x) {
  var result = x * x;
  console.log(result);
  return result;
};
