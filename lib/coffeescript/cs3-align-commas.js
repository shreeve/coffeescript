...
(function() {
  ...
  // ==============================================================================
  var content, currentRuleLines, currentRuleName, fs, i, inRule, j, len, line, lines, match, outputContent, outputLines, path, processRuleGroup, syntaxPath;
  ...
  processRuleGroup = function(ruleLines) {
    var aligned, alignedLine, currentWidth, indent, item, j, k, len, len1, line, match, maxPatternWidth, pattern, patternClose, patternWidth, patterns, rest, spacesNeeded;
    ...
    maxPatternWidth = 0;
    patterns = [];
    for (j = 0, len = ruleLines.length; j < len; j++) {
      line = ruleLines[j];
