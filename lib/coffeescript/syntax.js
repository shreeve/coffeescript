...
(function() {
  ...
  grammar = {
    ...
    AlphaNumeric: [
      o('NUMBER',
      {
        $ast: 'NumberLiteral',
        arg1: '$1.toString()',
        arg2: 'parsedValue: $1.parsedValue'
      }),
      o('String')
    ],
    String: [
      ...
      o('STRING_START Interpolations STRING_END',
      {
        ...
        arg1: 'Block.wrap($2)',
        arg2: 'quote: $1.quote',
        arg3: 'startQuote: (new Literal $1.toString()'
      })
    ],
    Interpolations: [
    ...
    Regex: [
      o('REGEX',
      {
        $ast: 'RegexLiteral',
        arg1: '$1.toString()',
        arg2: 'delimiter: $1.delimiter',
        arg3: 'heregexCommentTokens: $1.heregexCommentTokens'
      }),
      o('REGEX_START Invocation REGEX_END',
      {
        ...
        arg2: 'heregexCommentTokens: $3.heregexCommentTokens'
      })
    ],
    ...
    ObjAssignable: [
      ...
      o('@ [ Expression ]',
      {
        ...
        arg2: {
          $ary: ['(new ComputedPropertyName($3))']
        },
        arg3: 'this'
      }),
      o('AlphaNumeric')
    ...
    ObjSpreadIdentifier: [o('SimpleObjAssignable Accessor', o('ObjSpreadExpr Accessor'))], // TODO: Transform manually: (new Value $1).add $2 // TODO: Transform manually: (new Value $1).add $2
    ...
    YieldReturn: [
      o('YIELD RETURN Expression',
      {
        ...
        arg2: 'returnKeyword: (new Literal $2'
      }),
      o('YIELD RETURN',
      {
        $ast: '@',
    ...
    Accessor: [
      ...
      o(':: Property',
      {
        $ary: ['(new Access new PropertyName(\'prototype\')',
      'shorthand: yes)',
      '(new Access $2)']
      }),
      o('?:: Property',
    ...
    RangeDots: [o('..', o('...'))], // TODO: Transform manually: exclusive: no // TODO: Transform manually: exclusive: yes
    ...
    Range: [
      o('[ Expression RangeDots Expression ]',
      {
        ...
        arg3: 'if $3.exclusive then \'exclusive\' else \'inclusive\''
      }),
    ...
    Slice: [
      o('Expression RangeDots Expression',
      {
        ...
        arg3: 'if $2.exclusive then \'exclusive\' else \'inclusive\''
      }),
      ...
      o('RangeDots Expression',
      {
        ...
        arg3: 'if $1.exclusive then \'exclusive\' else \'inclusive\''
      }),
      o('RangeDots',
      {
        $ast: 'Range',
    ...
    Loop: [
      ...
      {
        $ast: 'While',
        arg1: '(new BooleanLiteral \'true\')',
        arg2: 'isLoop: yes).addBody $2'
      }),
      o('LOOP Expression',
      {
        $ast: 'While',
        arg1: '(new BooleanLiteral \'true\')',
        arg2: 'isLoop: yes).addBody LOC(2) Block.wrap [$2]'
      })
    ],
    ...
    ForSource: [o('FORIN Expression', o('FOROF Expression', o('FORIN Expression WHEN Expression', o('FORIN ExpressionLine WHEN Expression', o('FOROF Expression WHEN Expression', o('FOROF ExpressionLine WHEN Expression', o('FORIN Expression BY Expression', o('FORIN ExpressionLine BY Expression', o('FORIN Expression WHEN Expression BY Expression', o('FORIN ExpressionLine WHEN Expression BY Expression', o('FORIN Expression WHEN ExpressionLine BY Expression', o('FORIN ExpressionLine WHEN ExpressionLine BY Expression', o('FORIN Expression BY Expression WHEN Expression', o('FORIN ExpressionLine BY Expression WHEN Expression', o('FORIN Expression BY ExpressionLine WHEN Expression', o('FORIN ExpressionLine BY ExpressionLine WHEN Expression', o('FORFROM Expression', o('FORFROM Expression WHEN Expression', o('FORFROM ExpressionLine WHEN Expression')))))))))))))))))))], // TODO: Transform manually: source: $2 // TODO: Transform manually: source: $2, object: yes // TODO: Transform manually: source: $2, guard: $4 // TODO: Transform manually: source: $2, guard: $4 // TODO: Transform manually: source: $2, guard: $4, object: yes // TODO: Transform manually: source: $2, guard: $4, object: yes // TODO: Transform manually: source: $2, step:  $4 // TODO: Transform manually: source: $2, step:  $4 // TODO: Transform manually: source: $2, guard: $4, step: $6 // TODO: Transform manually: source: $2, guard: $4, step: $6 // TODO: Transform manually: source: $2, guard: $4, step: $6 // TODO: Transform manually: source: $2, guard: $4, step: $6 // TODO: Transform manually: source: $2, step:  $4, guard: $6 // TODO: Transform manually: source: $2, step:  $4, guard: $6 // TODO: Transform manually: source: $2, step:  $4, guard: $6 // TODO: Transform manually: source: $2, step:  $4, guard: $6 // TODO: Transform manually: source: $2, from: yes // TODO: Transform manually: source: $2, guard: $4, from: yes // TODO: Transform manually: source: $2, guard: $4, from: yes
    ForLineSource: [o('FORIN ExpressionLine', o('FOROF ExpressionLine', o('FORIN Expression WHEN ExpressionLine', o('FORIN ExpressionLine WHEN ExpressionLine', o('FOROF Expression WHEN ExpressionLine', o('FOROF ExpressionLine WHEN ExpressionLine', o('FORIN Expression BY ExpressionLine', o('FORIN ExpressionLine BY ExpressionLine', o('FORIN Expression WHEN Expression BY ExpressionLine', o('FORIN ExpressionLine WHEN Expression BY ExpressionLine', o('FORIN Expression WHEN ExpressionLine BY ExpressionLine', o('FORIN ExpressionLine WHEN ExpressionLine BY ExpressionLine', o('FORIN Expression BY Expression WHEN ExpressionLine', o('FORIN ExpressionLine BY Expression WHEN ExpressionLine', o('FORIN Expression BY ExpressionLine WHEN ExpressionLine', o('FORIN ExpressionLine BY ExpressionLine WHEN ExpressionLine', o('FORFROM ExpressionLine', o('FORFROM Expression WHEN ExpressionLine', o('FORFROM ExpressionLine WHEN ExpressionLine')))))))))))))))))))], // TODO: Transform manually: source: $2 // TODO: Transform manually: source: $2, object: yes // TODO: Transform manually: source: $2, guard: $4 // TODO: Transform manually: source: $2, guard: $4 // TODO: Transform manually: source: $2, guard: $4, object: yes // TODO: Transform manually: source: $2, guard: $4, object: yes // TODO: Transform manually: source: $2, step:  $4 // TODO: Transform manually: source: $2, step:  $4 // TODO: Transform manually: source: $2, guard: $4, step: $6 // TODO: Transform manually: source: $2, guard: $4, step: $6 // TODO: Transform manually: source: $2, guard: $4, step: $6 // TODO: Transform manually: source: $2, guard: $4, step: $6 // TODO: Transform manually: source: $2, step:  $4, guard: $6 // TODO: Transform manually: source: $2, step:  $4, guard: $6 // TODO: Transform manually: source: $2, step:  $4, guard: $6 // TODO: Transform manually: source: $2, step:  $4, guard: $6 // TODO: Transform manually: source: $2, from: yes // TODO: Transform manually: source: $2, guard: $4, from: yes // TODO: Transform manually: source: $2, guard: $4, from: yes
    Switch: [
    ...
    Operation: [
      o('UNARY Expression',
      {
        ...
        arg3: void 0,
        arg4: void 0,
        arg5: 'originalOperator: $1.original'
      }),
      o('DO Expression',
      {
        $ast: 'Op',
      ...
      o('Expression COMPARE  Expression',
      {
        ...
        arg4: void 0,
        arg5: 'originalOperator: $2.original'
      }),
      o('Expression &        Expression',
      {
        $ast: 'Op',
      ...
      o('Expression RELATION Expression',
      {
        ...
        arg4: void 0,
        arg5: 'invertOperator: $2.invert?.original ? $2.invert'
      }),
  ...
  module.exports = {
    ...
    operators: operators != null ? operators.reverse() : void 0,
    start: 'Root'
  };
