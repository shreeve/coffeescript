...
(function() {
  ...
  // ==============================================================================
  var example, i, j, k, len, len1, len2, note, ref, ref1, sig, signatures;
  ...
  signatures = [
    {
      ...
      examples: ["$ast: '@'                                    # Minimal - type = rule name",
    ...
    },
    {
      ...
      examples: ["$ref: 1                                      # Simple reference to $1",
  ...
  {$use: 'temp'}                              #   Return 'temp'
      ...
      notes: ["$as: 'name' - Store value in temporary variable",
    ...
    },
    {
      ...
      examples: ["$ops: 'Block.wrap', args: [$ref: 1]         # Static method",
  ...
  then: $ast: 'Assign', left: $ref: 1
    ...
    },
    {
      ...
      examples: ["$pos: [1, 1, 1, 12]                          # Single line",
    "$pos: [10, 5, 15, 20]                        # Multi-line span",
    "$pos: [2, 3, 2, 3]                           # Single character"],
      notes: ["1-indexed (line 1 = first line, column 1 = first character)",
