...
(function() {
  ...
  CS3DebugBackend = class CS3DebugBackend {
    ...
    evaluate(d, fr, rn = null) {
      var accessor, arr, arrays, bodyNode, elseBlock, ifBlock, item, items, j, k, len, len1, len2, len3, loopNode, m, mapped, n, o, op, out, propName, propValue, q, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, s, sourceNode, t, target, v, val;
      if (typeof d === 'number') {
...
// Merge source properties into loop
        ...
        if (d.$seq != null) {
          ...
          for (q = 0, len3 = ref6.length; q < len3; q++) {
            s = ref6[q];
            r = this.evaluate(s, fr, rn);
            return r;
          }
        }
        if (d.$ite != null) {
          if (this.evaluate(d.$ite.test, fr, rn)) {
            return this.evaluate(d.$ite.then, fr, rn);
          } else {
            return this.evaluate(d.$ite.else, fr, rn);
          }
        }
        o = {};
        for (k in d) {
