...
(function() {
  ...
  CS3DebugBackend = class CS3DebugBackend {
    ...
    evaluate(d, fr, rn = null) {
      var accessor, arr, arrays, bodyNode, elseBlock, ifBlock, item, items, j, k, l, len, len1, len2, len3, loopNode, m, mapped, n, o, op, out, propName, propValue, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, s, sourceNode, t, target, v, val;
      if (typeof d === 'number') {
...
`);
  ...
  compileScript = function(file, input, base = null) {
    var compiled, dir, js, message, options, saveTo, task, tokens;
    ...
    try {
      ...
      if (opts['cs3-tokens']) {
        ...
        return printLine(JSON.stringify(dir, null, 2));
      } else if (opts['cs3']) {
