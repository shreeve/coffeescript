  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    tokenize(code, opts = {}) {
      ...
      while (this.chunk = code.slice(i)) {
        consumed = this.ctToken() || this.identifierToken() || this.commentToken() || this.whitespaceToken() || this.lineToken() || this.stringToken() || this.numberToken() || this.jsxToken() || this.regexToken() || this.jsToken() || this.literalToken();
        // Update position.
    ...
    ctToken() {
      var ct, match;
      if (!(this.chunk.charAt(0) === '•' && (match = CTTOKEN.exec(this.chunk)))) {
        return 0;
      }
      this.token('CT', (ct = match[0]).slice(2), 0, ct.length);
      return ct.length;
    }
