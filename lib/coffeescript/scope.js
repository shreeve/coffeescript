  ...
  exports.Scope = Scope = class Scope {
    ...
    find(name, type = 'var') {
      ...
      if (this.check(name)) {
        ...
        if (variable = this.getVariable(name)) {
          if (type !== 'param') {
    ...
    isReassigned(name) {
      var ref, ref1;
      return (ref = (ref1 = this.getVariable(name)) != null ? ref1.reassigned : void 0) != null ? ref : false;
    }
    ...
    markDeclarationHandled(name) {
      var variable;
      if (variable = this.getVariable(name)) {
        return variable.declarationHandled = true;
      }
    }
    ...
    declaredVariables() {
      ...
      return ((function() {
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          v = ref[i];
          if (v.type === 'var' && !v.alreadyDeclared) {
