...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var args, argsNode, array, attempt, attemptNode, body, bodyNode, bound, clause, condition, context, delimiter, elseBody, elseNode, ensure, exclusive, expression, expressions, flags, flip, forNode, from, fullRegex, generated, guard, i, idx, index, inner, invertOperator, j, key, left, len, len1, name, nameNode, nodeType, object, objects, op, originalOperator, params, paramsNode, parent, parsedValue, pattern, prop, properties, quote, recovery, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, source, splat, step, tail, templateArg, test, to, vNode, value, valueNode, variable, variableNode;
