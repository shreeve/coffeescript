...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var args, argsNode, array, attempt, attemptNode, body, bodyNode, bound, cases, casesNode, clause, condition, conditions, conditionsNode, context, delimiter, elseBody, elseNode, ensure, error, exclusive, expression, expressions, finalBody, flags, flip, forNode, from, fullRegex, generated, guard, i, idx, index, inner, invertOperator, isLoop, j, key, left, len, len1, loopNode, name, nameNode, node, nodeType, object, objects, op, opts, originalOperator, otherwise, own, params, paramsNode, parent, parsedValue, pattern, prop, properties, quote, recovery, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, source, sourceObj, splat, step, subject, tail, templateArg, test, to, vNode, value, valueNode, variable, variableNode, whileNode;
