...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var args, argsNode, array, attempt, attemptNode, body, bodyItem, bodyNode, bodyNodes, bound, cases, casesNode, clause, condition, conditions, conditionsNode, context, converted, delimiter, elseBody, elseNode, ensure, error, exclusive, expression, expressions, finalBody, flags, flip, forNode, from, fullRegex, generated, guard, i, idx, index, inner, invertOperator, isLoop, j, k, key, left, len, len1, len2, loopNode, name, nameNode, node, nodeType, object, objects, op, opts, originalOperator, otherwise, own, params, paramsNode, parent, parsedValue, pattern, prop, properties, quote, recovery, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, source, sourceObj, splat, step, subProp, subject, tail, templateArg, test, to, vNode, value, valueNode, variable, variableNode, whileNode;
    ...
    solarNodeToClass(solarNode) {
      var array, body, clause, first, flags, from, fullRegex, nameNode, object, objects, pattern, properties, ref1, second, source, to, value, variable;
      ...
      switch (solarNode.type) {
        ...
        case 'Access':
          nameNode = ((ref1 = solarNode.name) != null ? ref1.type : void 0) ? this.solarNodeToClass(solarNode.name) : solarNode.name ? new nodes.PropertyName(solarNode.name) : new nodes.PropertyName('');
          return new nodes.Access(nameNode, {
            soak: solarNode.soak,
