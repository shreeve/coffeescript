...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var accessor, arg, args, argsNode, array, arraySource, body, bodyNode, clause, directiveCopy, evaluated, exprDirective, expression, filteredBody, flattened, flip, glyph, idx, implicitValue, inner, innerDirective, invertOperator, item, itemCopy, j, k, key, l, left, len, len1, len2, len3, len4, literal, m, n, name, nameDirective, nameNode, negated, node, nodeType, object, op, opNode, originalOperator, prop, properties, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, source, step, subProp, superNode, tail, templateArg, vNode, validProps, value, valueNode, varName, varValue, variable, variableNode;
      ...
      if ((directive != null) && typeof directive === 'object') {
        ...
        // $ary directive (array creation)
          ...
          // Handle both simple array format and position reference format
          arraySource = Array.isArray(directive.$ary) ? directive.$ary : directive.$ary;
          
          // If $ary is a number, it's a position reference to an existing array
          if (typeof arraySource === 'number') {
            result = this.evaluateDirective(arraySource, frame, ruleName);
            result = this.toArray(result);
          } else {
            // Create new array from elements
            result = [];
            for (m = 0, len3 = arraySource.length; m < len3; m++) {
              item = arraySource[m];
