  ...
  ES5Backend = class ES5Backend {
    constructor(options1 = {}) {
      ...
      this.compileOptions = {
        ...
        es6: (ref2 = this.options.es6) != null ? ref2 : true, // Default to ES6 for CS3!
        header: (ref3 = this.options.header) != null ? ref3 : false,
        sourceMap: (ref4 = this.options.sourceMap) != null ? ref4 : false,
        inlineMap: (ref5 = this.options.inlineMap) != null ? ref5 : false,
    ...
    generate(node) {
      ...
      if (this.compileOptions.es6 && (node != null) && typeof node === 'object' && !node.compile) {
        this.variableInfo = this.analyzeVariables(node);
      }
    ...
    analyzeVariables(directive, info = {
        declarations: {},
        assignments: {},
        scopes: []
      }) {
      var item, j, key, len, ref1, ref2, ref3, ref4, value, varName;
      if (directive == null) {
        return info;
      }
      ...
      if (Array.isArray(directive)) {
        for (j = 0, len = directive.length; j < len; j++) {
          item = directive[j];
          this.analyzeVariables(item, info);
        }
        return info;
      }
      ...
      if (typeof directive === 'object') {
        ...
        if (directive.type === 'Assign') {
          varName = (ref1 = directive.variable) != null ? (ref2 = ref1.base) != null ? ref2.value : void 0 : void 0;
          if (varName && typeof varName === 'string') {
            if (directive.context) { // Compound assignment (+=, -=, etc.)
              info.assignments[varName] = (info.assignments[varName] || 0) + 1;
        ...
        for (key in directive) {
          ...
          if (!key.startsWith('$pos')) {
            this.analyzeVariables(value, info);
          }
        }
      }
      return info;
    ...
    getUniqueLoopVar() {
      ...
      idx = this.loopVarCounter % set.length;
      num = Math.floor(this.loopVarCounter / set.length);
      use = `${set[idx]}${num || ''}`;
      this.loopVarCounter++;
      this.usedLoopVars.add(use);
      return use;
    }
    ...
    createAssign(directive, frame, ruleName) {
      var assignNode, canBeConst, context, operator, options, ref1, value, varName, variable;
      ...
      if (directive.context === 'object' && (directive.expression != null)) {
        ...
        if (this.compileOptions.es6 && this.variableInfo && variable instanceof nodes.Value) {
          varName = (ref1 = variable.base) != null ? ref1.value : void 0;
          if (varName && typeof varName === 'string') {
            // Variable can be const if it's declared but never reassigned
            canBeConst = this.variableInfo.declarations[varName] && !this.variableInfo.assignments[varName];
