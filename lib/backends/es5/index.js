...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    solarNodeToClass(solarNode) {
      var array, body, clause, context, converted, expr, expressions, first, flags, flatExpressions, from, fullRegex, i, item, j, len, len1, name, nameNode, node, object, objects, operator, options, pattern, properties, ref1, ref2, ref3, second, source, to, value, variable;
