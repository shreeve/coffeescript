...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var accessor, actualExpression, arg, args, argsNode, arr, array, atValue, attempt, attemptNode, block, blockNode, body, bodyItem, bodyNode, bodyNodes, bound, cases, casesNode, catchDirective, clause, cleanValue, codeNode, cond, condition, conditions, conditionsNode, context, converted, deepFlatten, deepFlattenToNodes, delimiter, directiveCopy, elseBody, elseNode, ensure, ensureNode, ensured, error, errorNode, evaluated, exclusive, exclusiveVal, expr, exprDirective, expression, expressionNode, expressions, filteredBody, finalBody, fixedProps, flags, flatExpressions, flip, forNode, frameValue, from, fromNode, fullRegex, funcGlyph, generated, glyph, guard, hasSuper, i, idx, ifNode, incrementVar, index, inner, innerDirective, invert, invertOperator, isAwait, isCtor, isLoop, item, itemCopy, j, k, key, l, leadingSpaces, left, len, len1, len2, len3, len4, len5, len6, len7, len8, line, lines, literal, loopNode, loopVar, m, minIndent, n, name, nameArray, nameDirective, nameNode, negated, node, nodeType, obj, object, objects, op, opNode, operator, options, opts, origEachSuper, origFlag, originalCompileNode, originalOperator, otherwise, own, params, paramsNode, parent, parsedValue, pattern, postfix, processedConditions, prop, propName, propNameStr, properties, q, quote, r, range, recovery, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, s, source, sourceObj, splat, step, subProp, subject, superNode, t, tag, tail, templateArg, test, thisNode, to, toNode, type, u, vNode, validProps, value, valueNode, varName, varValue, variable, variableNode, whileNode;
      ...
      if ((directive != null) && typeof directive === 'object') {
          ...
          switch (nodeType) {
            ...
            case 'Param':
              ...
              if (name instanceof nodes.Obj || (name instanceof nodes.Value && name.base instanceof nodes.Obj)) {
                ...
                obj.generated = false;
                if (obj.properties) {
                  ref15 = obj.properties;
                  for (i = q = 0, len4 = ref15.length; q < len4; i = ++q) {
                    prop = ref15[i];
                    if (!(prop instanceof nodes.Assign && ((ref16 = prop.value) != null ? ref16.this : void 0))) {
                      continue;
                    }
            ...
            case 'Body':
              ...
              if (Array.isArray(expressions)) {
                for (r = 0, len5 = expressions.length; r < len5; r++) {
                  expr = expressions[r];
                  if (Array.isArray(expr)) {
                    for (s = 0, len6 = expr.length; s < len6; s++) {
                      item = expr[s];
            ...
            case 'Splat':
              ...
              nameDirective = (ref17 = directive.name) != null ? ref17 : directive.body;
            ...
            case 'Expansion':
              ...
              exprDirective = (ref18 = directive.expression) != null ? ref18 : directive.body;
            ...
            case 'SwitchWhen':
              ...
              conditionsNode = (function() {
                ...
                if (Array.isArray(conditions)) {
                  processedConditions = [];
                  for (t = 0, len7 = conditions.length; t < len7; t++) {
                    cond = conditions[t];
        ...
        // $seq directive (sequences)
          ...
          result = null;
          ref20 = directive.$seq;
          for (u = 0, len8 = ref20.length; u < len8; u++) {
            step = ref20[u];
