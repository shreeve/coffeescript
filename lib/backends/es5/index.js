...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    applyOperation(directive, frame, ruleName) {
      var bodyArg, bodyNode, evaluated, item, j, k, len, len1, loopNode, position, propNode, propRaw, ref1, ref2, ref3, ref4, ref5, ref6, result, sourceInfo, target, targetNode, targetRaw, value;
