...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var args, argsNode, arr, array, attempt, attemptNode, blockNode, body, bodyItem, bodyNode, bodyNodes, bound, cases, casesNode, clause, cond, condition, conditions, conditionsNode, context, converted, delimiter, elseBody, elseNode, ensure, ensured, error, evaluated, exclusive, expr, expression, expressions, filteredBody, finalBody, fixedProps, flags, flatExpressions, flip, forNode, from, fullRegex, generated, guard, i, idx, index, inner, invertOperator, isLoop, item, itemCopy, j, k, key, l, left, len, len1, len2, len3, len4, len5, len6, loopNode, m, n, name, nameNode, node, nodeType, obj, object, objects, op, opts, originalOperator, otherwise, own, params, paramsNode, parent, parsedValue, pattern, processedConditions, prop, properties, q, quote, recovery, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, source, sourceObj, splat, step, subProp, subject, tail, templateArg, test, thisNode, to, vNode, validProps, value, valueNode, variable, variableNode, whileNode;
