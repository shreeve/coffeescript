    ...
    evaluateDirective(directive, frame, ruleName = null) {
      ...
      if ((directive != null) && typeof directive === 'object') {
              ...
              if (name instanceof nodes.Obj) {
                ...
                if (Array.isArray(name.properties)) {
                  ...
                  for (q = 0, len4 = ref15.length; q < len4; q++) {
                    prop = ref15[q];
                    if (prop != null) {
                      if (prop.variable instanceof nodes.Value && prop.variable.base instanceof nodes.ThisLiteral) {
                ...
                if (Array.isArray(obj.properties)) {
                  ref16 = obj.properties;
                  for (r = 0, len5 = ref16.length; r < len5; r++) {
                    prop = ref16[r];
                    if (prop != null) {
                      if (prop.variable instanceof nodes.Value && prop.variable.base instanceof nodes.ThisLiteral) {
                        prop.variable.this = true;
        ...
        // $seq directive (sequences)
          ...
          result = null;
          ref20 = directive.$seq;
          for (w = 0, len9 = ref20.length; w < len9; w++) {
            step = ref20[w];
