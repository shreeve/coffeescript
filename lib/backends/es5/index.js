    ...
    evaluateDirective(directive, frame, ruleName = null) {
      ...
      if ((directive != null) && typeof directive === 'object') {
        ...
        // $ast directive (AST node creation)
          ...
          switch (nodeType) {
            ...
            case 'Code':
              ...
              if (typeof directive.body === 'number' && (frame != null ? (ref13 = frame.rhs) != null ? ref13[directive.body - 1] : void 0 : void 0)) {
              ...
              if (hasSuper) {
                ...
                codeNode.eachSuperCall = function(context, iterator) {
                  var expr, len4, q, ref14;
                  // For CS3 code with super, pretend we found it
                  if (iterator) {
                    ref14 = bodyNode.expressions;
                    // Find the actual super call node
                    for (q = 0, len4 = ref14.length; q < len4; q++) {
                      expr = ref14[q];
            ...
            case 'Splat':
              ...
              nameDirective = (ref14 = directive.name) != null ? ref14 : directive.body;
            ...
            case 'Expansion':
              ...
              exprDirective = (ref15 = directive.expression) != null ? ref15 : directive.body;
        ...
        // $ary directive (array creation)
          ...
          result = [];
          ref16 = directive.$ary;
          for (s = 0, len6 = ref16.length; s < len6; s++) {
            item = ref16[s];
        ...
        // $seq directive (sequences)
          ...
          result = null;
          ref17 = directive.$seq;
          for (t = 0, len7 = ref17.length; t < len7; t++) {
            step = ref17[t];
