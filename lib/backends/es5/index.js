...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var accessor, actualExpression, arg, args, argsNode, arr, array, atValue, attempt, attemptNode, blockNode, body, bodyItem, bodyNode, bodyNodes, bound, cases, casesNode, catchDirective, clause, cleanValue, codeNode, cond, condition, conditions, conditionsNode, context, converted, delimiter, directiveCopy, elseBody, elseNode, ensure, ensureNode, ensured, error, errorNode, evaluated, exclusive, exclusiveVal, expr, exprDirective, expression, expressionNode, expressions, filteredBody, finalBody, fixedProps, flags, flatExpressions, flattened, flip, forNode, frameValue, from, fromNode, fullRegex, funcGlyph, generated, glyph, guard, hasSuper, i, idx, ifNode, incrementVar, index, inner, innerDirective, invert, invertOperator, isAwait, isCtor, isLoop, item, itemCopy, j, k, key, l, left, len, len1, len2, len3, len4, len5, len6, len7, len8, literal, loopNode, loopVar, m, n, name, nameArray, nameDirective, nameNode, negated, node, nodeType, obj, object, objects, op, opNode, operator, options, opts, origEachSuper, origFlag, originalCompileNode, originalOperator, otherwise, own, params, paramsNode, parent, parsedValue, pattern, postfix, processedConditions, prop, propName, propNameStr, properties, q, quote, r, range, recovery, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, s, source, sourceObj, splat, step, subProp, subject, superNode, t, tag, tail, templateArg, test, thisNode, to, toNode, type, vNode, validProps, value, valueNode, varName, varValue, variable, variableNode, whileNode;
