...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var args, argsNode, arr, array, attempt, attemptNode, body, bodyItem, bodyNode, bodyNodes, bound, cases, casesNode, clause, condition, conditions, conditionsNode, context, converted, delimiter, elseBody, elseNode, ensure, error, evaluated, exclusive, expr, expression, expressions, filteredBody, finalBody, flags, flatExpressions, flip, forNode, from, fullRegex, generated, guard, i, idx, index, inner, invertOperator, isLoop, item, itemCopy, j, k, key, l, left, len, len1, len2, len3, len4, len5, loopNode, m, n, name, nameNode, node, nodeType, obj, object, objects, op, opts, originalOperator, otherwise, own, params, paramsNode, parent, parsedValue, pattern, prop, properties, quote, recovery, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, source, sourceObj, splat, step, subProp, subject, tail, templateArg, test, to, vNode, value, valueNode, variable, variableNode, whileNode;
