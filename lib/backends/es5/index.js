...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var args, argsNode, arr, array, attempt, attemptNode, blockNode, body, bodyItem, bodyNode, bodyNodes, bound, cases, casesNode, clause, cond, condition, conditions, conditionsNode, context, converted, delimiter, elseBody, elseNode, ensure, ensureNode, ensured, error, evaluated, exclusive, exclusiveVal, expr, exprDirective, expression, expressions, filteredBody, finalBody, fixedProps, flags, flatExpressions, flip, forNode, from, fromNode, fullRegex, generated, guard, i, idx, index, inner, invertOperator, isLoop, item, itemCopy, j, k, key, l, left, len, len1, len2, len3, len4, len5, len6, loopNode, m, n, name, nameDirective, nameNode, node, nodeType, obj, object, objects, op, operator, options, opts, originalOperator, otherwise, own, params, paramsNode, parent, parsedValue, pattern, processedConditions, prop, properties, q, quote, recovery, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, source, sourceObj, splat, step, subProp, subject, tail, templateArg, test, thisNode, to, toNode, vNode, validProps, value, valueNode, variable, variableNode, whileNode;
    ...
    solarNodeToClass(solarNode) {
      var array, body, clause, context, converted, exclusive, expr, expressions, first, flags, flatExpressions, from, fullRegex, i, item, j, len, len1, name, nameNode, node, object, objects, operator, options, pattern, properties, ref1, ref2, ref3, second, source, to, value, variable;
