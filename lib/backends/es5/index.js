...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    createCode(directive, frame, ruleName) {
      var body, bodyNode, bodyNodes, bound, codeNode, frameValue, funcGlyph, hasSuper, isCtor, origEachSuper, origFlag, params, paramsNode, ref1;
      ...
      if (typeof directive.body === 'number' && (frame != null ? (ref1 = frame.rhs) != null ? ref1[directive.body - 1] : void 0 : void 0)) {
