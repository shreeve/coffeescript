...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var args, argsNode, arr, array, attempt, attemptNode, blockNode, body, bodyItem, bodyNode, bodyNodes, bound, cases, casesNode, clause, cond, condition, conditions, conditionsNode, context, converted, delimiter, elseBody, elseNode, ensure, ensured, error, evaluated, exclusive, expr, exprDirective, expression, expressions, filteredBody, finalBody, fixedProps, flags, flatExpressions, flip, forNode, from, fullRegex, generated, guard, i, idx, index, inner, invertOperator, isLoop, item, itemCopy, j, k, key, l, left, len, len1, len2, len3, len4, len5, len6, loopNode, m, n, name, nameDirective, nameNode, node, nodeType, obj, object, objects, op, operator, options, opts, originalOperator, otherwise, own, params, paramsNode, parent, parsedValue, pattern, processedConditions, prop, properties, q, quote, recovery, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, source, sourceObj, splat, step, subProp, subject, tail, templateArg, test, thisNode, to, vNode, validProps, value, valueNode, variable, variableNode, whileNode;
          ...
          switch (nodeType) {
            ...
            case 'Assign':
              ...
              if (directive.context === 'object' && (directive.expression != null)) {
                ...
                options = {};
                if (directive.operator != null) {
                  operator = this.evaluateDirective(directive.operator, frame, ruleName);
                  if (operator) {
            ...
            case 'Try':
              ...
              attemptNode = Array.isArray(attempt) ? new nodes.Block(this.filterNodes(attempt)) : attempt ? attempt : new nodes.Block([]);
    ...
    solarNodeToClass(solarNode) {
      var array, body, clause, converted, expr, expressions, first, flags, flatExpressions, from, fullRegex, i, item, j, len, len1, name, nameNode, node, object, objects, operator, options, pattern, properties, ref1, ref2, ref3, second, source, to, value, variable;
      ...
      switch (solarNode.type) {
        ...
        case 'Assign':
          ...
          if (solarNode.operator) {
            operator = typeof solarNode.operator === 'string' ? solarNode.operator : ((ref1 = solarNode.operator) != null ? typeof ref1.toString === "function" ? ref1.toString() : void 0 : void 0) ? solarNode.operator.toString() : void 0;
            if (operator) {
              options.operatorToken = {
                value: operator
              };
          ...
          return new nodes.Assign(variable, value, solarNode.context, options);
        case 'Arr':
