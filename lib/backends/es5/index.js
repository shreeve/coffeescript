...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var args, argsNode, attempt, attemptNode, body, bodyNode, bound, condition, context, elseBody, elseNode, ensure, exclusive, expression, expressions, flip, forNode, from, generated, guard, i, idx, index, inner, invertOperator, j, key, left, len, len1, name, nameNode, nodeType, objects, op, originalOperator, params, paramsNode, parent, parsedValue, prop, properties, quote, recovery, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, source, splat, step, tail, templateArg, test, to, vNode, value, valueNode, variable, variableNode;
    ...
    solarNodeToClass(solarNode) {
      var first, from, objects, properties, second, to, value, variable;
      ...
      switch (solarNode.type) {
        ...
        case 'StringLiteral':
          return new nodes.StringLiteral(solarNode.value, {
