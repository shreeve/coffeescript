...
(function() {
  ...
  ES5Backend = class ES5Backend {
    ...
    evaluateDirective(directive, frame, ruleName = null) {
      var actualExpression, arg, args, argsNode, arr, array, atValue, attempt, attemptNode, block, blockNode, body, bodyItem, bodyNode, bodyNodes, bound, cases, casesNode, catchDirective, clause, cleanValue, codeNode, cond, condition, conditions, conditionsNode, context, converted, deepFlatten, deepFlattenToNodes, delimiter, directiveCopy, elseBody, elseNode, ensure, ensureNode, ensured, error, errorNode, evaluated, exclusive, exclusiveVal, expr, exprDirective, expression, expressionNode, expressions, filteredBody, finalBody, fixedProps, flags, flatExpressions, flip, forNode, frameValue, from, fromNode, fullRegex, funcGlyph, generated, glyph, guard, hasSuper, i, idx, ifNode, incrementVar, index, inner, innerDirective, invert, invertOperator, isAwait, isCtor, isLoop, item, itemCopy, j, k, key, l, leadingSpaces, left, len, len1, len2, len3, len4, len5, len6, len7, len8, len9, line, lines, loopNode, loopVar, m, minIndent, n, name, nameArray, nameDirective, nameNode, negated, node, nodeType, obj, object, objects, op, opNode, operator, options, opts, origEachSuper, origFlag, originalCompileNode, originalOperator, otherwise, own, params, paramsNode, parent, parsedValue, pattern, postfix, processedConditions, prop, propName, propNameStr, properties, q, quote, r, range, recovery, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19, ref2, ref20, ref21, ref22, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, right, s, source, sourceObj, splat, step, subProp, subject, t, tag, tail, templateArg, test, thisNode, to, toNode, type, u, vNode, validProps, value, valueNode, varName, varValue, variable, variableNode, w, whileNode;
      ...
      if ((directive != null) && typeof directive === 'object') {
        ...
        // $ast directive (AST node creation)
          ...
          switch (nodeType) {
              ...
              if (generated) {
                ...
                for (n = 0, len3 = properties.length; n < len3; n++) {
                  ...
                  if (prop instanceof nodes.Value && prop.base instanceof nodes.IdentifierLiteral && !((ref12 = prop.properties) != null ? ref12.length : void 0)) {
                    ...
                    if (((ref13 = prop.properties) != null ? ref13[0] : void 0) instanceof nodes.Access) {
            ...
            case 'if':
              ...
              bodyNode = Array.isArray(body) ? (block = new nodes.Block(this.filterNodes(body)), block.locationData != null ? block.locationData : block.locationData = this.defaultLocationData(), block) : body;
              elseNode = elseBody ? Array.isArray(elseBody) ? (block = new nodes.Block(this.filterNodes(elseBody)), block.locationData != null ? block.locationData : block.locationData = this.defaultLocationData(), block) : elseBody : null;
            ...
            case 'For':
              ...
              if (body != null ? body.expressions : void 0) {
                ...
                bodyNode = new nodes.Block(this.filterNodes(body.expressions));
              } else if (Array.isArray(body)) {
                bodyNode = new nodes.Block(this.filterNodes(body));
              } else if (body) {
                bodyNode = body;
              ...
              forNode.compileNode = (o) => {
                var e, originalFreeVariable, preAllocatedVars, ref14, userName, varCounter;
            ...
            case 'Code':
              ...
              if (typeof directive.body === 'number' && (frame != null ? (ref14 = frame.rhs) != null ? ref14[directive.body - 1] : void 0 : void 0)) {
            ...
            case 'Param':
              ...
              if (name instanceof nodes.Obj) {
                ...
                if (Array.isArray(name.properties)) {
                  fixedProps = [];
                  ref15 = name.properties || [];
                  for (q = 0, len4 = ref15.length; q < len4; q++) {
                    prop = ref15[q];
                    if (prop instanceof nodes.Assign && ((ref16 = prop.value) != null ? ref16.this : void 0) && prop.context === 'object') {
                      ...
                      atValue.this = true;
                      atValue.locationData = prop.locationData || this.defaultLocationData();
              ...
              } else if (name instanceof nodes.Value && name.base instanceof nodes.Obj) {
                name.base.generated = false;
                // Same transformation for Value-wrapped Obj
                if (Array.isArray(name.base.properties)) {
                  fixedProps = [];
                  ref17 = name.base.properties || [];
                  for (r = 0, len5 = ref17.length; r < len5; r++) {
                    prop = ref17[r];
                    if (prop instanceof nodes.Assign && ((ref18 = prop.value) != null ? ref18.this : void 0) && prop.context === 'object') {
                      // This is an @ parameter - create a CS2-style Value node
                      // CS2 expects: Value with this=true, base=ThisLiteral, properties=[Access(PropertyName)]
                      atValue = new nodes.Value(new nodes.ThisLiteral());
                      // Use PropertyName instead of IdentifierLiteral for property access
            ...
            case 'Body':
              ...
              if (Array.isArray(expressions)) {
                for (s = 0, len6 = expressions.length; s < len6; s++) {
                  expr = expressions[s];
                  if (Array.isArray(expr)) {
                    for (t = 0, len7 = expr.length; t < len7; t++) {
                      item = expr[t];
            ...
            case 'Splat':
              ...
              nameDirective = (ref19 = directive.name) != null ? ref19 : directive.body;
            ...
            case 'Expansion':
              ...
              exprDirective = (ref20 = directive.expression) != null ? ref20 : directive.body;
            ...
            case 'SwitchWhen':
              ...
              conditionsNode = (function() {
                ...
                if (Array.isArray(conditions)) {
                  processedConditions = [];
                  for (u = 0, len8 = conditions.length; u < len8; u++) {
                    cond = conditions[u];
        ...
        // $seq directive (sequences)
          ...
          result = null;
          ref22 = directive.$seq;
          for (w = 0, len9 = ref22.length; w < len9; w++) {
            step = ref22[w];
    ...
    solarNodeToClass(solarNode) {
      ...
      switch (solarNode.type) {
        ...
        case 'Assign':
          ...
          context = (solarNode.expression != null) && (solarNode.variable == null) && !(solarNode.context === 'object') ? null : solarNode.operator ? (operator = typeof solarNode.operator === 'string' ? solarNode.operator : ((ref3 = solarNode.operator) != null ? typeof ref3.toString === "function" ? ref3.toString() : void 0 : void 0) ? solarNode.operator.toString() : void 0, operator) : solarNode.context;
          options = {};
        ...
        case 'if':
          // if statement
          bodyNode = ((ref6 = solarNode.body) != null ? ref6.expressions : void 0) ? (block = new nodes.Block(solarNode.body.expressions), block.locationData != null ? block.locationData : block.locationData = this.defaultLocationData(), block) : this.ensureNode(solarNode.body);
        ...
        case 'unless':
          ...
          bodyNode = ((ref7 = solarNode.body) != null ? ref7.expressions : void 0) ? (block = new nodes.Block(solarNode.body.expressions), block.locationData != null ? block.locationData : block.locationData = this.defaultLocationData(), block) : this.ensureNode(solarNode.body);
          elseNode = solarNode.elseBody ? solarNode.elseBody.expressions ? (block = new nodes.Block(solarNode.elseBody.expressions), block.locationData != null ? block.locationData : block.locationData = this.defaultLocationData(), block) : this.ensureNode(solarNode.elseBody) : null;
