...
var alt, alternatives, grammar, name, o, operators, unwrap, hasProp = {}.hasOwnProperty;
...
grammar = {
  ...
  String: [
    o('STRING', function() {
      return new StringLiteral($1.slice(1, -1), { // strip artificial quotes and unwrap to primitive string
        quote: $1.quote,
  ...
  Export: [
    ...
    o('EXPORT Identifier = Expression', function() {
      return new ExportNamedDeclaration(LOC(2, 4)(new Assign($2, $4, null, {
        moduleDeclaration: 'export'
      })));
    }),
    o('EXPORT Identifier = TERMINATOR Expression', function() {
      return new ExportNamedDeclaration(LOC(2, 5)(new Assign($2, $5, null, {
        moduleDeclaration: 'export'
      })));
    }),
    o('EXPORT Identifier = INDENT Expression OUTDENT', function() {
      return new ExportNamedDeclaration(LOC(2, 6)(new Assign($2, $5, null, {
        moduleDeclaration: 'export'
      })));
    }),
