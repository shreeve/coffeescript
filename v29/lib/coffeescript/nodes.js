...
export var Block = (function() {
  ...
  class Block extends Base {
    ...
    compileWithDeclarations(o) {
      var assigns, comma, declaredVariable, declaredVariables, declaredVariablesIndex, declars, exp, fragments, i, j, k, len1, len2, post, ref1, rest, scope, spaced;
      fragments = [];
      post = [];
      ref1 = this.expressions;
          ...
          if (declars) {
            ...
            for (declaredVariablesIndex = k = 0, len2 = declaredVariables.length; k < len2; declaredVariablesIndex = ++k) {
              ...
              if (declaredVariablesIndex !== declaredVariables.length - 1) {
                comma = this.makeCode(', ');
                comma.isVarDeclarationComma = true; // Mark this comma so arrays don't reformat it
...
//### JSX
export var JSXIdentifier = class JSXIdentifier extends IdentifierLiteral {
  astType() {
    return 'JSXIdentifier';
  }
...
export var JSXTag = class JSXTag extends JSXIdentifier {
...
export var JSXExpressionContainer = (function() {
...
export var JSXEmptyExpression = class JSXEmptyExpression extends Base {};

export var JSXText = class JSXText extends Base {
...
export var JSXAttribute = (function() {
...
export var JSXAttributes = (function() {
...
export var JSXNamespacedName = (function() {
...
export var JSXElement = (function() {
...
export var Arr = (function() {
  ...
  class Arr extends Base {
    ...
    compileNode(o) {
      var answer, compiledObjs, fragment, fragmentIndex, fragmentIsElision, fragments, includesLineCommentsOnNonFirstElement, index, j, k, l, len1, len2, len3, len4, len5, obj, objIndex, olen, p, passedElision, q, ref1, separator, unwrappedObj;
      if (!this.objects.length) {
      ...
      for (index = k = 0, len2 = compiledObjs.length; k < len2; index = ++k) {
        ...
        if (index !== 0 && passedElision && (!fragmentIsElision(fragments) || index === olen - 1)) {
          ...
          separator.isArraySeparator = true; // Mark this as an array element separator
