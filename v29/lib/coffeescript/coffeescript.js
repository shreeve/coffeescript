...
export var compile = withPrettyErrors(function(code, options = {}) {
  var ast, before, currentColumn, currentLine, encoded, filename, fragment, fragments, full, generateSourceMap, header, i, j, js, len, len1, map, match, newLines, nodes, range, ref, sourceCodeLastLine, sourceCodeNumberOfLines, sourceMapDataURI, sourceURL, token, tokens, v3SourceMap, varDecl;
  ...
  header = options.header ? `// Generated by CoffeeScript ${VERSION}\n` : "";
  if (match = js.match(/^((?:(?:\/\/.*|\s*)(?:\n|$))*?)(var\s+[\s\S]*?;\n+)/m)) {
