...
export var compile = withPrettyErrors(function(code, options = {}) {
  var ast, before, currentColumn, currentLine, encoded, filename, fragment, fragments, full, generateSourceMap, header, i, js, len, map, match, newLines, nodes, range, sourceCodeLastLine, sourceCodeNumberOfLines, sourceMapDataURI, sourceURL, token, tokens, v3SourceMap, varDecl;
